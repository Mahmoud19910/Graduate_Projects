...
@Database(entities = {UsersInfo.class, Users_Health_Info.class , Exercise_Details.class , Doctor.class , FoodCategory.class , My_Meal_List.class , Sports_Exercises.class}, version = 17, exportSchema = false)
